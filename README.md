...
<p>I'm Software Engineer at LTTS with two years of project and hand-on experience in full-stack development and a deep rooted passion for coding. I hold my Bachelor's degree in Computer Science and Engineering from Silicon Institute of Technology, Sambalpur. Over the past two years, I've joned my skills in vuilding scalable and robust web-application, driven by strong foundation of Competitive Programming and Data-structure. 
My expertise posses a broad and adaptable skill-set across a comprehensive texh-stack which includes Spring-boot, AWS, Asp.NET Core, MySQL, JavaScript, ReactJs, HTML, CSS</p>
...
- 💬 Ask me about ** Java, Spring-boot, Asp.NET Core, MySQL, JavaScript, ReactJs **
